...
<body>
	...
	<div style="position:  relative; left: 30px;">
		<h3>更新交易</h3>
	  	<div style="position: relative; top: -40px; left: 70%;">
			...
			<button type="button" onclick="defaultBtn()" class="btn btn-default">取消</button>
		</div>
	...
	<form class="form-horizontal" action="workbench/transaction/upDate.do" role="form" id="editForm" method="post" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			<label for="edit-transactionName" class="col-sm-2 control-label">宴会地点<span style="font-size: 15px; color: red;">*</span></label>
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" name="name" id="edit-name" value="${tMap.t.name}">
			</div>
			<label for="edit-expectedClosingDate" class="col-sm-2 control-label">宴会日期<span style="font-size: 15px; color: red;">*</span></label>
			<div class="col-sm-10" style="width: 300px;">
		...
		<div class="form-group">
			<label for="edit-accountName" class="col-sm-2 control-label">宴会类型<span style="font-size: 15px; color: red;">*</span></label>
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" name="type" id="edit-type" value="${tMap.t.type}" <%--placeholder="支持自动补全，输入客户不存在则新建"--%>>
			</div>
		...
		<div class="form-group">
			<label for="edit-transactionType" class="col-sm-2 control-label">订金</label>
			<div class="col-sm-10" style="width: 300px;">
		...
		<%--<div class="form-group">
			<label for="edit-contactsName" class="col-sm-2 control-label">下次联系时间&nbsp;&nbsp;<a href="javascript:void(0);" data-toggle="modal" data-target="#findContacts"><span class="glyphicon glyphicon-search"></span></a></label>
			<div class="col-sm-10" style="width: 300px;">
